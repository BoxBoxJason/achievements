  ...
  export namespace icons {
    ...
    export namespace achievements {
      ...
      export const speaker: { [key: string]: string[] } = {
        ...
        JAVASCRIPT_SPEAKER: ['icons', 'achievements', 'speaker', 'javascript.png'],
        TYPESCRIPT_SPEAKER: ['icons', 'achievements', 'speaker', 'typescript.png'],
        ...
        POWERSHELL_SPEAKER: ['icons', 'achievements', 'speaker', 'powershell.png'],
        ...
        'OBJECTIVE-C_SPEAKER': ['icons', 'achievements', 'speaker', 'objective-c.png'],
      ...
      export const creator: { [key: string]: string[] } = {
        ...
        JAVASCRIPT_CREATOR: ['icons', 'achievements', 'creator', 'javascript.png'],
        TYPESCRIPT_CREATOR: ['icons', 'achievements', 'creator', 'typescript.png'],
        ...
        POWERSHELL_CREATOR: ['icons', 'achievements', 'creator', 'powershell.png'],
        ...
        'OBJECTIVE-C_CREATOR': ['icons', 'achievements', 'creator', 'objective-c.png'],
