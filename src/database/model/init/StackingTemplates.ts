...
export namespace StackingTemplates {
  ...
  export const STANDARD_MEDIUM_CRITERIA_FUNCTION = (x: number) =>
    2 ** ((x + 2) >> 1) * 5 ** ((x + 1) >> 1);
  export const STANDARD_HARD_CRITERIA_FUNCTION = (x: number) =>
    2 ** (x >> 1) * 5 ** ((x + 1) >> 1);
  export const STANDARD_INFERNAL_CRITERIA_FUNCTION = (x: number) =>
    2 ** Math.max(0, (x - 1) >> 1) * 3 ** (x === 1 ? 1 : 0) * 5 ** (x >> 1);
  ...
  export namespace files {
    ...
    export const filesCreatedLanguageTemplates =
    ...
    export const filesRenamedCountTemplate =
      (): StackingAchievementTemplate => ({
    ...
    export const directoriesCreatedTemplate =
      (): StackingAchievementTemplate => ({
        title: "Shaper %d",
  ...
  export namespace git {
    ...
    export const mergesAndRebasesTemplate =
      (): StackingAchievementTemplate => ({
        title: "Merger %d",
        icon: "GIT_MERGE",
        category: constants.category.GIT,
  ...
  export namespace productivity {
    ...
    export const linesOfCodeLanguageTemplates =
      (): StackingAchievementTemplate[] =>
        Object.values(constants.labels.LANGUAGES).map((language) => ({
          ...
          labels: [
            ...
            constants.labels.LINES_OF_CODE,
          ],
          criterias: [
    ...
    export const linesOfCommentTemplate = (): StackingAchievementTemplate => ({
      ...
      labels: [
        constants.category.PRODUCTIVITY,
        constants.labels.LINES_OF_COMMENTS,
      ],
    ...
    export const numberOfPastesTemplate = (): StackingAchievementTemplate => ({
      ...
      labels: [
        constants.category.PRODUCTIVITY,
        constants.labels.NUMBER_OF_PASTES,
      ],
    ...
    export const numberOfSimultaneousTabsTemplate =
      (): StackingAchievementTemplate => ({
        title: "Tab Hoarder %d",
        icon: "TAB_HOARDER",
        category: constants.category.PRODUCTIVITY,
  ...
  export namespace vscode {
    ...
    export const extensionsInstalledTemplate =
      (): StackingAchievementTemplate => ({
    ...
    export const extensionsOutdatedTemplate =
      (): StackingAchievementTemplate => ({
    ...
    export const debuggerSessionsTemplate =
      (): StackingAchievementTemplate => ({
    ...
    export const terminalCommandsTemplate =
      (): StackingAchievementTemplate => ({
        title: "Commander %d",
        icon: "TERMINAL_TASK",
        category: constants.category.VSCODE,
    ...
    export const failedTerminalCommandsTemplate =
      (): StackingAchievementTemplate => ({
        ...
        criteriasFunctions: [STANDARD_INFERNAL_CRITERIA_FUNCTION],
        description: `Run ${constants.criteria.FAILED_TERMINAL_TASKS} failing vscode tasks or terminal command`,
        minTier: 0,
        maxTier: 10,
        expFunction: STANDARD_EXP_FUNCTION,
        hidden: false,
    ...
    export const successfulTerminalCommandsTemplate =
      (): StackingAchievementTemplate => ({
        ...
        criteriasFunctions: [STANDARD_INFERNAL_CRITERIA_FUNCTION],
        description: `Run ${constants.criteria.SUCCESSFUL_TERMINAL_TASKS} successful vscode tasks or terminal command`,
        minTier: 0,
        maxTier: 10,
        expFunction: STANDARD_EXP_FUNCTION,
        hidden: false,
